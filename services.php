...
<head>
	<meta charset="utf-8">
	<title>Services | Speedy Auto Centre</title>
	<?php
...
<body>
	...
	<main>
		<section id="servicesFirstSection">
		...
		<section id="servicesSecondSection">
			...
			<div class="service service2">
				...
				<ul>
					...
					<li>- Holiday Check</li>
					<li>- Vehicle Check</li>
					<li>- 10 Point Vehicle Safety Check</li>
			...
			<div class="service service3">
				...
				<ul>
					...
					<li>- The Latest Test Equipment for Mechanical Vehicle Components</li>
			...
			<div class="service service4">
				...
				<ul>
					...
					<li>- Complimentary Light Test Using the Latest Test Equipment</li>
