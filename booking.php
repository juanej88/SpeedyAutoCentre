         ...
         <section id="bookingSecondSection">
            ...
            <form class="bookingForm" action="booking.php" method="POST">
               ...
               <section class="phoneNumber">
                  ...
                  <!-- <input id="phoneNumber" type="number" name="phone-number" required /> -->
               ...
               <section class="addComments hideComments">
                  ...
                  <textarea id="addComments" name="add-comments" rows="4"></textarea>
               </section>

               <section class="submitButton">
                  <input id="submitButton" type="submit" value="Submit Booking" />
               </section>
            </form>
         </section>
         <?php echo "<p>Hello</p>";?>
